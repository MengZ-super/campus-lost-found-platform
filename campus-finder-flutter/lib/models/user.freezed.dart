...
mixin _$UserProfile {
 ...
 int get id; String get username; String? get nickname; String? get phone; String? get email; String? get studentId; String? get avatar; String? get role; int? get gender; String? get genderText; int? get status; DateTime? get lastLoginTime; String? get lastLoginIp; DateTime? get createTime;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,username,nickname,phone,email,studentId,avatar,role,gender,genderText,status,lastLoginTime,lastLoginIp,createTime);

@override
String toString() {
  return 'UserProfile(id: $id, username: $username, nickname: $nickname, phone: $phone, email: $email, studentId: $studentId, avatar: $avatar, role: $role, gender: $gender, genderText: $genderText, status: $status, lastLoginTime: $lastLoginTime, lastLoginIp: $lastLoginIp, createTime: $createTime)';
}
...
@useResult
$Res call({
 int id, String username, String? nickname, String? phone, String? email, String? studentId, String? avatar, String? role, int? gender, String? genderText, int? status, DateTime? lastLoginTime, String? lastLoginIp, DateTime? createTime
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String username,  String? nickname,  String? phone,  String? email,  String? studentId,  String? avatar,  String? role,  int? gender,  String? genderText,  int? status,  DateTime? lastLoginTime,  String? lastLoginIp,  DateTime? createTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserProfile() when $default != null:
return $default(_that.id,_that.username,_that.nickname,_that.phone,_that.email,_that.studentId,_that.avatar,_that.role,_that.gender,_that.genderText,_that.status,_that.lastLoginTime,_that.lastLoginIp,_that.createTime);case _:
  return orElse();
...
class _UserProfile implements UserProfile {
  const _UserProfile({required this.id, required this.username, this.nickname, this.phone, this.email, this.studentId, this.avatar, this.role, this.gender, this.genderText, this.status, this.lastLoginTime, this.lastLoginIp, this.createTime});
